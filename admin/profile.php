...
$a=$_SESSION['admin'];
$conn = openCon();
$q=mysqli_query($conn,"select * from admin where aid=$a")or die ("QF");
                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                <div class="table-responsive table--no-card m-b-30" style="height: auto; width: 700px;" >
                                    <table width="76%" class="table table-borderless table-striped table-earning"  align="center">
                                        
                                            <tr>
                                                <td width="41%">Name</td>
                                                <td width="59%"><?php echo $data['name'];?></td>
                                            </tr>
                                            </tr>
                                      ...
                                      <tr>
                                        <td>Admin Photo </td>
                                        <td><img src="<?php echo $data['aphoto'];?>" width="150" height="200"></td>
                                    </table>
                                </div>
                            </div>
                        </div>
