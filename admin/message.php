                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Inquiries</h4>
...
$no=1;
                                               $conn = openCon();
                                               $detail=mysqli_query($conn,"select * from  inquiry order by i_id desc");
...
<td><?php echo $row['mobile']; ?></td>
        ...
        <footer>
            <div class="footer-area">
                <p>© copyright devloped and design: Om Shukla, Shrey Lalani And Asfak Deraiya.</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
