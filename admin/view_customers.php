                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Customers Data</h4>
...
$no=1;
$conn = openCon();
$q=mysqli_query($conn,"select * from  registration_table order by rid desc")or die ("Query Fail");
...
?>
    <tr>
      ...
      <td><a href="del_customer.php?did=<?php echo $data['rid'];?>" class="style1"onClick="return f1();"><img src="images/del1.png"></a> </td>
      </tr>
<?php
$no++;
}
