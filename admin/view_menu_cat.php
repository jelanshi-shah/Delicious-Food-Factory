                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Menu Categories</h4>
...
$no=1;
$q=mysqli_query($conn,"select * from  foodcategory_management order by f_id desc")or die ("Query Fail");
...
?>
    <tr>
      ...
      <td><a href="del_menu_cat.php?did=<?php echo $data['f_id'];?>" class="style1"onClick="return f1();"><img src="images/del1.png"></a> </td>
      </tr>
<?php
$no++;
}
